...
This exercise is designed to continue our 2D Platformer by creating an animated sprite and a State Machine. The concepts behind this exercise will be outlined in class.
...
The expectations for this exercise are that you will
 ...
 - [ ] Create states for idle, moving, moving_and_jumping, jumping, and falling
 - [ ] Edit the LICENSE and README.md
 - [ ] Commit and push your changes back to GitHub. Turn in the URL of your repository on Canvas.

## Instructions

Fork this repository. When that process has completed, make sure that the top of the repository reads [your username]/Exercise-04b-State-Machine. *Edit the LICENSE and replace BL-MSCH-C220 with your full name.* Commit your changes.
